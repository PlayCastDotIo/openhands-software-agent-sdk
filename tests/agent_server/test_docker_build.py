...
def test_all_tags_include_short_long_sha_and_branch():
    ...
    assert opts.all_tags == [
        "ghcr.io/playcastdotio/agent-server:abc1234-python",
        "ghcr.io/playcastdotio/agent-server:abc1234567890fedcba-python",
        "ghcr.io/playcastdotio/agent-server:feature-release-1-python",
    ]
...
def test_all_tags_includes_versioned_tags():
    ...
    assert "ghcr.io/playcastdotio/agent-server:abc1234-python" in all_tags
    assert "ghcr.io/playcastdotio/agent-server:abc1234567890-python" in all_tags
    # Versioned tags use bare semver (no "v" prefix)
    assert "ghcr.io/playcastdotio/agent-server:1-python" in all_tags
    assert "ghcr.io/playcastdotio/agent-server:1.2-python" in all_tags
    assert "ghcr.io/playcastdotio/agent-server:1.2.0-python" in all_tags
    assert "ghcr.io/playcastdotio/agent-server:1.2.0-java" in all_tags
    assert "ghcr.io/playcastdotio/agent-server:1-java" in all_tags
...
def test_all_tags_excludes_versioned_tags_when_disabled():
    ...
    assert "ghcr.io/playcastdotio/agent-server:abc1234-python" in all_tags
    assert "ghcr.io/playcastdotio/agent-server:abc1234567890-python" in all_tags
    assert "ghcr.io/playcastdotio/agent-server:main-python" in all_tags
    assert "ghcr.io/playcastdotio/agent-server:1-python" not in all_tags
...
def test_all_tags_with_arch_suffix():
    ...
    # Versioned tags use bare semver (no "v" prefix)
    assert "ghcr.io/playcastdotio/agent-server:1-python-amd64" in all_tags
    assert "ghcr.io/playcastdotio/agent-server:1.2-python-amd64" in all_tags
    assert "ghcr.io/playcastdotio/agent-server:1.2.0-python-amd64" in all_tags
    assert "ghcr.io/playcastdotio/agent-server:abc1234567890-python-amd64" in all_tags
...
def test_all_tags_with_target_suffix():
    ...
    assert "ghcr.io/playcastdotio/agent-server:1-python-source" in all_tags
    assert "ghcr.io/playcastdotio/agent-server:1.2-python-source" in all_tags
    assert "ghcr.io/playcastdotio/agent-server:1.2.0-python-source" in all_tags
    assert "ghcr.io/playcastdotio/agent-server:abc1234567890-python-source" in all_tags
